{
  ...
  # Systems
  outputs = { self, nixpkgs, flake-utils, home-manager, npmlock2nix, bpmn-to-image, dmn-to-html, robot-task, lezer-feel, parrot-rcc, rcc, zbctl, ... }: flake-utils.lib.eachDefaultSystem (system: let pkgs = nixpkgs.legacyPackages.${system}; in {
